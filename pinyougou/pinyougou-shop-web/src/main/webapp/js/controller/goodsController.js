app.controller("goodsController", function ($scope, $controller, $location, goodsService, uploadService,
    ...
    $scope.findOne = function () {
        //获取路径中的商品id；$location.search()获取到一个json对象
    ...
    $scope.$watch("entity.goods.typeTemplateId", function (newValue, oldValue) {
        if (newValue != undefined) {
            ...
            //返回的数据结构：如：[{"id":27,"text":" 网 络 ","options":[{"id":111,"optionName":" 移 动3G","specId":27,"orders":null}]},
            // {"id":32,"text":" 机 身 内 存","options":[{"id":222,"optionName":"16G","specId":32,"orders":null},
            // {"id":223,"optionName":"32G","specId":32,"orders":null}]}]
    ...
    addColumn = function (itemList, specName, specOptions) {
        ...
        for (var i = 0; i < itemList.length; i++) {
            ...
            for (var j = 0; j < specOptions.length; j++) {
                ...
                //深度克隆；JSON.stringify将一个json转换为一个json字符串；
